...
const LEGAL_CONTENT: Record<'en' | 'zh-Hans' | 'zh-Hant', Record<LegalTab, LegalContent>> = {
    en: {
        privacy: {
    ...
    'zh-Hans': {
        privacy: {
            ...
            sections: [
                {
                    heading: '我们收集的数据',
                    body: '我们可能收集你的邮箱、昵称、头像、专业、社交标签、贴子、评论、上传图片、私信内容、推送令牌，以及你主动附加到地图或贴文的位置。',
                },
                {
                    heading: '数据用途',
                ...
                {
                    heading: '定位、相册与生物识别',
                    body: '定位权限仅在你主动使用定位功能时请求。相册和相机权限仅在你主动选择或拍摄图片时使用。Face ID 仅用于本机快捷登录，不会上传你的生物特征数据。',
                },
                {
                    heading: '存储与共享',
        ...
        terms: {
            ...
            sections: [
                ...
                {
                    heading: '贴文与评论',
                    body: '在功能开放的地方，你可以删除自己的贴文和评论。违反社区规则的内容也可能被管理员移除。',
                },
                {
                    heading: '消息撤回',
    ...
    'zh-Hant': {
        privacy: {
            title: '隱私政策',
            intro: 'HKCampus 僅收集提供校園功能、社群互動與帳號安全所必需的資料。',
            sections: [
                {
                    heading: '我們收集的資料',
                    body: '我們可能收集你的電子郵箱、暱稱、頭像、專業、社交標籤、貼文、評論、上傳圖片、私訊內容、推播令牌，以及你主動附加到地圖或貼文的位置。',
                },
                {
                    heading: '資料用途',
                    body: '這些資料用於建立帳號、展示個人資料、發佈內容與訊息、處理審核與檢舉、在你開啟通知後發送提醒，以及在你主動使用時提供地圖相關功能。',
                },
                {
                    heading: '定位、相簿與生物辨識',
                    body: '定位權限僅在你主動使用定位功能時請求。相簿和相機權限僅在你主動選擇或拍攝圖片時使用。Face ID 僅用於本機快速登入，不會上傳你的生物辨識資料。',
                },
                {
                    heading: '儲存與共享',
        ...
        terms: {
            title: '刪除與撤回說明',
            intro: 'HKCampus 在應用內提供帳號刪除、內容刪除與部分場景下的訊息撤回能力。',
            sections: [
                {
                    heading: '帳號刪除',
                    body: '你可以在「個人中心 > 註銷帳號」發起刪除。該操作不可恢復，目標是刪除你的帳號及相關應用內資料。',
                },
                {
                    heading: '貼文與評論',
                ...
                {
                    heading: '檢舉與審核',
                    body: '用戶可以檢舉內容並封鎖他人。被檢舉內容可能依據社群安全規則進行審核與處理。',
                },
            ],
        },
    },
...
const TAB_LABELS: Record<'en' | 'zh-Hans' | 'zh-Hant', Record<LegalTab, string>> = {
    en: { privacy: 'Privacy', terms: 'Deletion' },
    'zh-Hans': { privacy: '隐私', terms: '删除说明' },
    'zh-Hant': { privacy: '隱私', terms: '刪除說明' },
};

const normalizeLanguage = (language: string): 'en' | 'zh-Hans' | 'zh-Hant' => {
