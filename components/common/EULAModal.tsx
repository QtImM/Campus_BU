...
export const EULAModal: React.FC<EULAModalProps> = ({ visible, onAccept }) => {
    ...
    const copy = {
        ...
        'zh-Hans': {
            ...
            prohibitedList: '骚扰辱骂、仇恨歧视、威胁恐吓、色情剥削、暴力内容、诈骗引流、垃圾广告、违法活动，以及任何针对其他用户的滥用行为，均被禁止。',
        ...
        'zh-Hant': {
            title: '社群安全協議',
            zeroTolerance: '零容忍政策',
            policyDesc: 'HKCampus 是一個 18+ 社群。我們不允許不良內容與濫用使用者。違規內容會被立即移除，違規帳號可能被封鎖。',
            prohibitedTitle: '禁止內容',
            prohibitedList: '騷擾辱罵、仇恨歧視、威脅恐嚇、色情剝削、暴力內容、詐騙引流、垃圾廣告、違法活動，以及任何針對其他使用者的濫用行為，均被禁止。',
            moderationTitle: '你可以如何保護自己',
            moderationDesc: '你可以檢舉不當內容、封鎖濫用使用者，並立即將貼文從 feed 中隱藏。我們會在 24 小時內處理檢舉。',
            enforcementTitle: '處置方式',
            enforcementDesc: '一旦檢舉內容違反這些規則，我們會移除相關內容，並清退發布違規內容的使用者。',
