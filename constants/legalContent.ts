    ...
    'zh-Hans': {
        privacy: {
            ...
            sections: [
                {
                    heading: '我们收集的数据',
                    body: '我们可能收集你的邮箱、昵称、头像、专业、社交标签、帖子、评论、上传图片、私信内容、推送令牌，以及你主动附加到地图或帖子中的位置信息。',
                },
                {
                    heading: '数据用途',
        ...
        terms: {
            ...
            sections: [
                {
                    heading: '零容忍政策',
                    body: '你不得发布、上传、传播或鼓励任何不良内容，包括骚扰辱骂、仇恨歧视、威胁恐吓、色情剥削、暴力内容、诈骗引流、垃圾广告、违法活动，以及任何针对其他用户的滥用行为。',
                },
                {
                    heading: '用户保护工具',
    ...
    'zh-Hant': {
        privacy: {
            ...
            sections: [
                {
                    heading: '我們收集的資料',
                    body: '我們可能收集你的電郵、暱稱、頭像、專業、社交標籤、貼文、評論、上傳圖片、私訊內容、推送令牌，以及你主動附加到地圖或貼文中的位置資訊。',
                },
                {
                    heading: '資料用途',
                    body: '這些資料用於建立帳戶、展示資料、發布內容與訊息、支援審核處理、在你開啟通知後發送提醒，以及在你主動使用時提供地圖相關功能。',
                },
                {
                    heading: '定位、相簿與生物識別',
                    body: '定位權限僅在你主動使用定位功能時請求；相簿和相機權限僅在你主動選擇圖片時使用；Face ID 僅用於裝置本地登入便利，不會上傳你的生物特徵資料。',
                },
                {
                    heading: '儲存與共享',
        ...
        terms: {
            title: '使用條款與社群安全',
            intro: 'HKCampus 是一個 18+ 校園社群。使用本 App 即表示你同意這些條款，並接受我們對不良內容與濫用使用者的零容忍政策。',
            sections: [
                {
                    heading: '零容忍政策',
                    body: '你不得發布、上傳、傳播或鼓勵任何不良內容，包括騷擾辱罵、仇恨歧視、威脅恐嚇、色情剝削、暴力內容、詐騙引流、垃圾廣告、違法活動，以及任何針對其他使用者的濫用行為。',
                },
                {
                    heading: '使用者保護工具',
                    body: '使用者可以檢舉不當內容、封鎖濫用使用者，並立即將貼文從自己的 feed 中隱藏。封鎖後，該使用者的內容會從你可見的動態與對話中移除。',
                },
                {
                    heading: '審核與處置',
                    body: '我們會在 24 小時內處理檢舉。若內容違反本條款，我們會移除相關內容，並可能對違規帳號進行暫停或永久封鎖，且無需事先通知。',
                },
                {
                    heading: '支援與聯絡方式',
                    body: '你可以透過 App 內的檢舉入口或「個人中心 > 幫助與支援」檢舉不當行為，也可以直接聯絡 huoweijia2000@163.com 或 huoweijia2000@gmail.com。',
                },
            ],
        },
    },
